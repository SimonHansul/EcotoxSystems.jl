...
include("test06_ibm_defparams.jl") # simulates default individual-based model with debkiss_defaultparams
include("test07_alternative_ind_params.jl") # adding individual parameters to the debkiss_defaultparams
